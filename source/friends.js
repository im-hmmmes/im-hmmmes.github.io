function loadQexoFriends(id, url) {
    ...
    var loadStyle = '<div class="qexo_loading"><div class="qexo_part"><div style="display: flex; justify-content: center"><div class="qexo_loader"><div class="qexo_inner one"></div><div class="qexo_inner two"></div><div class="qexo_inner three"></div></div></div></div><p style="text-align: center; display: block">Friend links loading...</p></div>';
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                alert("Oops, your browser cannot upload files!");
                return false;
            }
        }
    }
    ...
    ajax.onreadystatechange = function () {
        if (ajax.readyState == 4) {
            if (ajax.status == 200) {
                ...
                console.log("Failed to get friend links! Network error");
            }
        }
    };
    ajax.send(null);
